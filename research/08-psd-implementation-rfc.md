...
| **Relationship to this repo** | **Seed document.** Move to the `psd` repository once it exists. |

> This is the *implementation* RFC: what to build, in what order, with which
> trade-offs. The *protocol* obligations are in
> [07 — Implementing a Person Server](07-person-server.md); this document does
